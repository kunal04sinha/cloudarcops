...
export const data = [
  ...
  {
    id: 5,
    title: "Creating a Streamlined DevOps Pipeline: From Commit to Cloud",
    imageUrl: automation,
    description:
      "In the fast-evolving landscape of software development, the need for speed and reliability in deploying applications is paramount. My recent project, which involved automating the application deployment process ....",
    buttonText: "Read More",
    buttonUrl: "#",
  },
  {
    id: 6,
    title: "Building a Scalable and Resilient Media Platform with AWS",
    imageUrl: sixth,
    description:
      "In today's digital age, the demand for fast, reliable, and scalable web services is paramount. We recently had the opportunity to architect and deploy a sophisticated media platform leveraging AWS's vast ecosystem.",
    buttonText: "Read More",
    buttonUrl: "#",
  },
];
